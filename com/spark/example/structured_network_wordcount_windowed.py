...
"""
 ...
 and then run the example
    `$ /usr/local/spark-2.0.2/bin/spark-submit /home/mandar/ProjectWorkspace/Example/com/spark/example/structured_network_wordcount_windowed.py localhost 9999 10  5`
